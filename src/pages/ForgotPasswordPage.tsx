      ...
      <div className="min-h-screen bg-light-800 dark:bg-dark-900 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white dark:bg-dark-800/80 backdrop-blur-sm border border-gray-200 dark:border-dark-600 p-6 shadow-xl text-center">
            ...
            <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-3">{t('forgot_password_page.check_email_title')}</h1>
    ...
    <div className="min-h-screen bg-light-800 dark:bg-dark-900 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">{t('forgot_password_page.forgot_password_title')}</h1>
          <p className="text-gray-500 dark:text-slate-400 text-sm">{t('forgot_password_page.forgot_password_description')}</p>
        </div>
