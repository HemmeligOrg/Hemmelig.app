  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center">
      <div className="bg-white dark:bg-dark-800/80 backdrop-blur-sm border border-gray-200 dark:border-dark-600 p-6 shadow-xl max-w-md w-full">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">{t('secret_not_found_page.title')}</h1>
        <p className="text-gray-500 dark:text-slate-400 text-sm mb-4">{t('secret_not_found_page.message')}</p>
