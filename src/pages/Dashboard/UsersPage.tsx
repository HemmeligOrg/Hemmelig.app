                        ...
                        <tbody className="divide-y divide-slate-800">
                            {filteredUsers.map((user) => (
                                <tr key={user.id}>
                                    ...
                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-slate-400">
                                        <span
                                            className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${user.banned ? 'bg-red-500/20 text-red-400' : 'bg-green-500/20 text-green-400'}`}
                                        >
                                            {user.banned
                                    ...
                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-slate-400 hidden sm:table-cell">
