...
export function AccountPage() {
    ...
    return (
        <div className="p-4 sm:p-6">
            {/* Header */}
            <div className="mb-6">
                <h1 className="text-xl sm:text-2xl font-bold text-white">{t('account_page.title')}</h1>
                <p className="text-slate-400 text-sm mt-1">{t('account_page.description')}</p>
            </div>
            ...
            <div className="max-w-2xl">
                {activeTab === 'profile' && (
                    <div className="bg-dark-800/80 backdrop-blur-sm border border-dark-600 p-4">
                        <div className="flex items-center space-x-3 mb-4">
                            <div className="p-2 bg-teal-500/20">
                                <User className="w-4 h-4 text-teal-400" />
                            </div>
                            <div>
                                <h2 className="text-base font-semibold text-white">{t('account_page.profile_info.title')}</h2>
                                <p className="text-xs text-slate-400">{t('account_page.profile_info.description')}</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 bg-dark-700/50 border border-dark-500/50 text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500/50 transition-all duration-300"
                                />
                            </div>
                            ...
                            <div className="pt-3">
                                <button
                                    ...
                                    disabled={isLoading}
                                    className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white text-sm transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                ...
                {activeTab === 'security' && (
                    <div className="bg-dark-800/80 backdrop-blur-sm border border-dark-600 p-4">
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            <div>
                                <h2 className="text-base font-semibold text-white">{t('account_page.security_settings.title')}</h2>
                                <p className="text-xs text-slate-400">{t('account_page.security_settings.description')}</p>
                            </div>
                        </div>

                        <div className="space-y-4">
                            <div>
                                <h3 className="text-sm font-medium text-white mb-3">{t('account_page.security_settings.change_password_title')}</h3>
                                <div className="space-y-3">
                                    <div>
                                        <label className="block text-sm font-medium text-slate-300 mb-1">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-10 pr-10 py-2 bg-dark-700/50 border text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 transition-all duration-300 ${passwordErrors.currentPassword ? 'border-red-500/50 focus:ring-red-500/50 focus:border-red-500/50' : 'border-dark-500/50 focus:ring-teal-500/50 focus:border-teal-500/50'}`}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-10 pr-10 py-2 bg-dark-700/50 border text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 transition-all duration-300 ${passwordErrors.newPassword ? 'border-red-500/50 focus:ring-red-500/50 focus:border-red-500/50' : 'border-dark-500/50 focus:ring-teal-500/50 focus:border-teal-500/50'}`}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-10 pr-10 py-2 bg-dark-700/50 border text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 transition-all duration-300 ${passwordErrors.confirmPassword ? 'border-red-500/50 focus:ring-red-500/50 focus:border-red-500/50' : 'border-dark-500/50 focus:ring-teal-500/50 focus:border-teal-500/50'}`}
                                    ...
                                    <button
                                        ...
                                        className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white text-sm transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                ...
                {activeTab === 'danger' && (
                    <div className="bg-dark-800/80 backdrop-blur-sm border border-red-500/30 p-4">
                        <div className="flex items-center space-x-3 mb-4">
                            <div className="p-2 bg-red-500/20">
                                <AlertTriangle className="w-4 h-4 text-red-400" />
                            </div>
                            <div>
                                <h2 className="text-base font-semibold text-white">{t('account_page.danger_zone.title')}</h2>
                                <p className="text-xs text-slate-400">{t('account_page.danger_zone.description')}</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="p-3 bg-red-500/10 border border-red-500/30">
                                ...
                                <button
                                    ...
                                    disabled={isLoading}
                                    className="flex items-center space-x-2 px-3 py-2 bg-red-600 hover:bg-red-700 text-white text-sm transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
