    ...
    <header className="pt-4 sm:pt-8 pb-4 sm:pb-6">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-between items-center mb-4 sm:mb-6">
          <Link to="/" className="flex items-center space-x-2 text-gray-900 dark:text-white hover:text-teal-500 dark:hover:text-teal-400 transition-colors duration-300">
        ...
        <div className="text-center">
          ...
          {settings.instanceDescription ? (
            ...
            <p className="text-sm sm:text-lg text-gray-600 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed px-4">
              ...
              <span className="text-teal-500 dark:text-teal-400 font-medium">{t('header.hero_text_part2')}</span>{t('header.hero_text_part3')}
            </p>
          )}
