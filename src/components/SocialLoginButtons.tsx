...
type SocialProvider = 'github' | 'google' | 'microsoft' | 'discord' | 'gitlab' | 'apple' | 'twitter';
...
const providerConfig: Record<SocialProvider, { name: string; icon: React.ReactNode; buttonClass: string }> = {
    github: {
        name: 'GitHub',
        icon: <GithubIcon />,
        buttonClass: 'bg-gray-900 hover:bg-black text-white dark:bg-gray-800 dark:hover:bg-gray-700',
    },
    google: {
        name: 'Google',
        icon: <GoogleIcon />,
