...
INSERT INTO "new_Secret" ("allowed_ip", "data", "expiresAt", "id", "isPublic", "maxViews", "password", "preventBurn", "title", "user_id") SELECT "allowed_ip", "data", "expiresAt", "id", "isPublic", "maxViews", "password", "preventBurn", "title", "user_id" FROM "Secret";
DROP TABLE "Secret";
